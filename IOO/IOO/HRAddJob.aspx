<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HRAddJob.aspx.cs" Inherits="HRAddJob" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="text-align: center; left: 50%; right: 50%; justify-content: center">
            ...
            <asp:Label Width="200" ID="lbl_newTitle" runat="server" Text="Title: "></asp:Label>
            ...
            <asp:Button ID="btn_addq" runat="server" Text="Add Questions" OnClick="addq" Width="112px" />
