<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HRViewTH.aspx.cs" Inherits="HRViewTH" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style ="text-align: center; left:50%; right: 50%; justify-content: center">
            ...
            <asp:Label Width="200" ID="Label1" runat="server" Text="Year: "></asp:Label>
            <asp:TextBox ID="txt_year" runat="server" TextMode="Number"></asp:TextBox>

            <br/>
            <asp:Button ID="Button3" runat="server" Text="View Staff Total Hours" onclick="viewth" Width="176px"/>
            <br />
            <asp:Button ID="Button1" runat="server" Text="Back" onclick="back" Width="176px"/>
